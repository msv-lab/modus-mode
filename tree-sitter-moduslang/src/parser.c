...
enum {
  ...
  sym_format_string_content = 15,
  sym_not_escape_sequence = 16,
  sym_constant_escape_sequence = 17,
  anon_sym_DOLLAR_LBRACE = 18,
  anon_sym_RBRACE = 19,
  sym_f_string_escape_sequence = 20,
  sym_comment = 21,
  sym_source_file = 22,
  sym_clause_definition = 23,
  sym_expression_body = 24,
  sym_literal_expression = 25,
  sym_unification = 26,
  sym_literal_definition = 27,
  sym_operator_definition = 28,
  sym_term_list = 29,
  sym_term_definition = 30,
  sym_constant_term = 31,
  sym_f_string_term = 32,
  sym_interpolation = 33,
  aux_sym_source_file_repeat1 = 34,
  aux_sym_expression_body_repeat1 = 35,
  aux_sym_term_list_repeat1 = 36,
  aux_sym_constant_term_repeat1 = 37,
  aux_sym_f_string_term_repeat1 = 38,
  alias_sym_body = 39,
  alias_sym_head = 40,
  alias_sym_variable_identifier = 41,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_clause_definition] = STATE(33),
    [sym_literal_definition] = STATE(56),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operator_definition, 1),
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_f_string_term_repeat1, 2),
  [39] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_f_string_term_repeat1, 2), SHIFT_REPEAT(11),
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_f_string_term_repeat1, 2), SHIFT_REPEAT(60),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_f_string_term_repeat1, 2), SHIFT_REPEAT(11),
  ...
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_body_repeat1, 2),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_body_repeat1, 2), SHIFT_REPEAT(57),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_body, 3),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_expression, 3),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_expression, 1),
  [77] = {.entry = {.count = 1, .reusable = false}}, SHIFT(41),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constant_term, 2),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_f_string_term, 3),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_f_string_term, 2),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constant_term, 3),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term_list, 3),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_definition, 2),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operator_definition, 2),
  [95] = {.entry = {.count = 1, .reusable = false}}, SHIFT(24),
  [97] = {.entry = {.count = 1, .reusable = false}}, SHIFT(40),
  [99] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 3, .production_id = 4),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3, .production_id = 4),
  ...
  [130] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_term_list_repeat1, 2), SHIFT_REPEAT(28),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_term_list_repeat1, 2),
  ...
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_clause_definition, 2, .production_id = 1),
